...
# CLAUDE.md — Multi-Agent Orchestration Framework
...
This file lives at the project root as `CLAUDE.md`. Claude Code reads it automatically at the start of every session. Every prompt you type will be processed through this framework automatically.
